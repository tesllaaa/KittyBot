...
def _friendly(status: int) -> str:
    return {
        ...
        502: "Проблема с соединением между серверами OpenRouter. Попробуйте позднее.",
        503: "OpenRouter сейчас недоступен. Пожалуйста, подождите и повторите попытку позже.",
        504: "Таймаут шлюза OpenRouter. Сервер не отвечает. Пожалуйста, подождите и повторите попытку позже.",
